...
function renderGame() {
  ...
  updateSlotsData(W, hpx, primarySlotHitboxLength, primarySlotDisplayLength + 4 * primarySlotDisplayLength * PETAL_OUTLINE_WIDTH_PERCENTAGE, primarySlotCenterY, primarySlotCount, secondarySlotHitboxLength, secondarySlotDisplayLength + 4 * secondarySlotDisplayLength * PETAL_OUTLINE_WIDTH_PERCENTAGE, secondarySlotCenterY, secondarySlotCount);
  if (state.me) {
  ...
  _animation["default"].play(renderGame);
}