...
var _default = Object.freeze({
  'default': {
    ...
    sub_orbit: 10,
    sub_orbit_type: '',
    // 'radial', 'rotate', 'radial_reverse'
    sub_orbit_rot_speed: 0,
    // rad / tick
    cuml_cnt: 0,
    skill_set: [],
    skill_var: {}
    ...
    skill_var: {
      ...
      spawn: {
        ...
        child: {
          ...
          attr: _petalAttr["default"]['peas_single']
        }
      },
      dir: {
        type: 'radial'
    ...
    skill_var: {
      ...
      spawn: {
        ...
        child: {
          ...
          attr: _petalAttr["default"]['peas_legendary_single']
        }
      },
      dir: {
        type: 'radial'
